...
for x in range(sim_start_no,no_of_sims):
    ...
    simulator = NeutralEvolutionSimulator(
        n_subs=71815,
        start_speci_file='/home/maria/run_simulations_cactus/auxiliary_wg/anc4_HCLCA/processed_gene_seqs.pkl',
        cbase_output='/home/maria/run_simulations_cactus/auxiliary_wg/cbase.csv',
        syn_probs_dir='/home/maria/run_simulations_cactus/auxiliary_wg/anc4_HCLCA/syn_target',
        non_syn_probs_dir='/home/maria/run_simulations_cactus/auxiliary_wg/anc4_HCLCA/nonsyn_target',
